            ...
            <div className="rounded-2xl border border-white/[0.07] bg-carvao2 p-8 md:p-10">
              ...
              <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  ...
                  <select className="w-full rounded-xl border border-white/[0.07] bg-carvao px-4 py-3 text-sm text-grafite outline-none focus:border-terra/40 transition-colors cursor-pointer">
                ...
                <button
                  type="submit"
                  className="self-start rounded-full px-7 py-3.5 text-sm font-medium text-white border-none cursor-pointer mt-2"
